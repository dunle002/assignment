...
<h2 style="color: red;text-align: center;margin-top: 100px">Product Detail</h2>
<div class="card mb-3" style="max-width: 540px;margin-left: 570px;margin-top: 100px">
    <div class="row g-0" >
        <div class="col-md-4">
            <td><img style="height: 250px;width: 200px" src="${product.imagePath}'"/></td>
        </div>
        <div class="col-md-8">
            <div class="card-body">
                <br> Name:
                ...
                <td>${product.title}</td>
                <br> Descripton:
                <td>${product.description}</td> <br> <br>
            </div>
        </div>
    </div>
</div>
