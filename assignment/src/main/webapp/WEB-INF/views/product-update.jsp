...
<h2 style="color: red;text-align: center;margin-top: 100px">Product Update</h2>
<div class="container" style="">
    <form action="/update?id=${product.id}" method="post" enctype="multipart/form-data">
        <div class="form-group">
            <label >Name Product</label>
            <input type="text" class="form-control" value="${product.nameproduct}"  name="nameproduct" placeholder="">
        </div>
        <div class="form-group">
            <label >Image</label>
<%--            <img type="file" class="form-control-file" name="imagePath" >--%>
            <input type="file" class="form-control-file" value="${product.imagePath}" name="imagePath" >
        </div>
        <div class="form-group">
            <label >Price</label>
        ...
        <div class="form-group">
            <label >Title</label>
            <input type="text" class="form-control" value="${product.title}" name="title" placeholder="">
        </div>
